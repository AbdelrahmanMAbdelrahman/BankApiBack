...
namespace BankApi.Migrations
{
    ...
    [Migration("20260815133947_makeEmpoyee.notesNull")]
    partial class makeEmpoyeenotesNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankApi.Models.Employee", b =>
                {
                    ...
                    b.HasIndex("UploadedImageID")
                        .IsUnique()
                        .HasFilter("[UploadedImageID] IS NOT NULL");
            ...
            modelBuilder.Entity("BankApi.Models.UploadedImage", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BankApi.Models.Employee", b =>
                {
                    b.HasOne("BankApi.Models.UploadedImage", "UploadedImage")
                        .WithOne("Employee")
                        .HasForeignKey("BankApi.Models.Employee", "UploadedImageID");
